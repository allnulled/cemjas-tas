...
//    - time:         0.014 seconds
//    - modules:      1
//       - 0. Pak.require("projects/currently/gui.js")
//    - styles:       0
//    - templates:    0
// @module[main] = Pak
(function(globalPak) {
  ...
  // @module[1] = projects/currently/gui.js
  (function(module) {
    try {

    } catch (error) {
      console.log("⛔️ Error on module projects/currently/gui.js\n  ", error);
      throw error;
    } finally {
      __LAST_PAK_RESULT__ = Pak.modules["projects/currently/gui.js"] = module.exports;
    }
  })({
    exports: undefined
  });
