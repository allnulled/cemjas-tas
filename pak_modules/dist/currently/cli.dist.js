...
(function(globalPak) {
  ...
  // @module[1] = projects/currently/cli.js
  (function(module) {
    try {

    } catch (error) {
      console.log("⛔️ Error on module projects/currently/cli.js\n  ", error);
      throw error;
    } finally {
      __LAST_PAK_RESULT__ = Pak.modules["projects/currently/cli.js"] = module.exports;
    }
  })({
    exports: undefined
  });
