// @pak-module:
// - Source generated:
//    - date:         Tue Apr 14 2026 20:45:46 GMT+0200 (hora de verano de Europa central)
//    - time:         0.014 seconds
//    - modules:      1
//       - 0. Pak.require("projects/currently/client.js")
//    - styles:       0
//    - templates:    0
// @module[main] = Pak
(function(globalPak) {
  ...
  // @module[1] = projects/currently/client.js
  (function(module) {
    try {

    } catch (error) {
      console.log("⛔️ Error on module projects/currently/client.js\n  ", error);
      throw error;
    } finally {
      __LAST_PAK_RESULT__ = Pak.modules["projects/currently/client.js"] = module.exports;
    }
  })({
    exports: undefined
  });
